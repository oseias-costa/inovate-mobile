...
type SelectStatusProps = {
  status: '' | 'PEDING' | 'FINISH' | 'EXPIRED'| 'DOCUMENT' | 'NOTICE';
  item: '' | 'PEDING' | 'FINISH' | 'EXPIRED' | 'DOCUMENT' | 'NOTICE';
  setStatus: Dispatch<SetStateAction<'' | 'PEDING' | 'FINISH' | 'EXPIRED' | 'DOCUMENT' | 'NOTICE'>>;
};
